...
const UI_TRANSLATIONS = {
  fr: {
    ...
    msgWlDuplicate: "Cet expéditeur est déjà en liste blanche.",
    msgStorageFull: "Stockage plein : la limite de 9 Ko des propriétés Apps Script est atteinte. Retirez des entrées avant d'en ajouter de nouvelles.",
    msgWlRemoved: "Expéditeur retiré de la liste blanche.",
    msgBrandAdded: "Marque personnalisée ajoutée.",
    msgBrandDuplicate: "Cette marque est déjà surveillée.",
  ...
  en: {
    ...
    msgWlDuplicate: "This sender is already on the allow list.",
    msgStorageFull: "Storage full: the 9 KB limit on Apps Script properties has been reached. Remove some entries before adding new ones.",
    msgWlRemoved: "Sender removed from the allow list.",
    msgBrandAdded: "Custom brand added.",
    msgBrandDuplicate: "This brand is already monitored.",
