...
const UI_TRANSLATIONS = {
  fr: {
    ...
    /* Panneau de contrôle */
    ctlTitle: "🛡️ Contrôle du détecteur",
    ...
    /* Liste blanche */
    wlTitle: "🛡️ Gestion de la liste blanche",
    ...
    brTitle: "🏷️ Surveillance de marques personnalisées",
  ...
  en: {
    ...
    /* Allow list */
    wlTitle: "🛡️ Allow list management",
    ...
    /* Custom brands */
    brTitle: "🏷️ Custom brand monitoring",
